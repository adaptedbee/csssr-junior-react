...
const ProductPage = ({product}) => {
  return (
    <article className="page">
      ...
      <section 
        className={product.isInStock ? 'product' : 'product product--out-of-stock'}>
        <div 
          className={product.isInStock ? 'product__status' : 'product__status product__status--out-of-stock'}>
